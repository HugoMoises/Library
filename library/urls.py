...
from .views import IndexView, LivroListView, LivroCreateView, LivroUpdateView, LivroDetailView, LivroDeleteView
urlpatterns = [
    ...
    path('livros/<int:pk>/delete', LivroDeleteView.as_view(), name='livro_delete'),
]